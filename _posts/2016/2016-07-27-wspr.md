...
QRP Labs出品的Ultimate3/3S QRSS/WSPR信标套件比较流行，低廉的成本，合适的功率。另外，Raspberry Pi加上个LPF也是不错的选择，但是GPIO的RF功率只有差不多10mW，对于天线不给力的朋友，挑战性较大。
...
昨晚上使用20米波段的加感GP天线发射，能够被日本电台接收到，最远的2234公里，折合成公里/瓦超过10000KM/W，而且昨天的SN是0，20米波段的传播较差的情况下。    
