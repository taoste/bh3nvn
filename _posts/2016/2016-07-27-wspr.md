...
加入WSPR网络，你可以通过搜索wsprnet.org的数据库了解学习不同季节，不同时间，不同波段的传播规律,这里有很多0dBM（1mW）超过1万公里的记录。    
...
-----------------------------------------------------------------------------------    		
 ...
 把PA部分FET的扼流电感按照下图改成1:4变压器之后，功率如下：    
 10米 250mW    
 20米 420mW    
 30米 620mW    
 40米 630mW    
 最大功率时候BS170电流大约400mA，满足规格书中最大Id500mA的要求，但是会发热，所以我加了一个简单的铁片散热。		
