...
手边正好有维修NWT-500剩的ERA-5SM1+，就想着制作一个1090MHZ的放大器。        
...
偏置电阻计算：（电源电压-器件电压）/偏置电流，由于计划使用5v供电，器件电压典型值4.9v，最低4.5v，偏置电流65mA，我按照4.7v计算，电阻大概4.7欧姆。
电容选用10pF，电感47uH。
...
先用20db衰减器和连接线校准失网，用s21模式测试增益大概16dB
